...
export const NavAfterLogin = (props) => {
  ...
  return (
      <nav className="navbar navbar-expand-lg navbar-light p-0 px-2" style={{ height: '10vh',background:'white', zIndex:'101' }}>
        <Link className="navbar-brand px-md-5" to="/">
        ...
        <div className="collapse navbar-collapse bg-white" id="navbarTogglerDemo02">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 px-2">
              ...
              <li className="nav-item">
                <Link className="nav-link fw-bold text-dark" style={{ fontSize: '2.3vh' }} to="#">Customer Support</Link>
              </li>
            </ul>
